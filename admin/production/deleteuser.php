...
$query=mysqli_query($conn,"select * from user where user.type='publisher'") or die("selecting error");
...
<h1>Online house publication system</h1>                  </a>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row" style="height:1000px;">
           <table border="1" style="position: absolute;left:400px;top:160px;">
...
$del1="DELETE FROM user where  user.uid='$uid'";
