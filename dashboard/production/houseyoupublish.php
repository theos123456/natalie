...
$query=mysqli_query($conn,"select * from publication,user where publication.uid=user.uid and user.uid='".$_SESSION['uid']."'") or die("selecting error");
        ...
        <div class="right_col" role="main">
          ...
          <div class="row" style="height:1000px;">
           <table border="1" style="position: absolute;left:350px;top:160px;">
            ...
            <td><img src="<?php echo $row['image'] ?>" width="80px" height="80px"></td>
